...
if __name__ == '__main__':
    ...
    args.num_steps=int((5425496 * args.max_epochs) / (args.batch_size * args.num_gpus * args.accumulate_gradients))
    ...
    val_check_interval=1000*args.accumulate_gradients,          #!!!!!!tag ,should be 500
